...
export const en = {
  ...
  modelSupportsImagesHint: 'Required for vision models. The page does not probe the endpoint; only this declaration admits image prompts.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '高级',
  modelSupportsImages: '支持图片',
  modelSupportsImagesHint: '视觉模型需要勾选。页面不会探测接口能力；只有此处声明后，带图消息才会被接受。',
  addModel: '添加模型',
  removeModel: '删除模型',
